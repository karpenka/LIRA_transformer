...
model.component('comp1').geom('geom1').feature('imp1').set('filename', 'C:\JOB\comsol\test\trying_comsol_to_matlab_octagon.stl');
...
model.mesh('mpart1').feature('imp1').set('filename', 'C:\JOB\comsol\test\trying_comsol_to_matlab_octagon.stl');
...
model.component('comp1').mesh('mesh1').export.set('filename', 'C:\JOB\comsol\test\mesh_transf2.stl');
model.component('comp1').mesh('mesh1').export('C:\JOB\comsol\test\mesh_transf2.stl');
model.component('comp1').mesh('mesh1').export('C:\JOB\comsol\test\mesh_transf2.stl');
